...
public class PoolingByteArrayOutputStream extends ByteArrayOutputStream {
     ...
     * the img_default size to which the underlying byte array is initialized.
     */
    ...
    /**
     * Constructs a new PoolingByteArrayOutputStream with a img_default size. If more bytes are written
    ...
    /**
     * Constructs a new {@code ByteArrayOutputStream} with a img_default size of {@code size} bytes. If
     * more than {@code size} bytes are written to this instance, the underlying byte array will
     * expand.
     *
     * @param size initial size for the underlying byte array. The value will be pinned to a img_default
     *        minimum size.
     */
